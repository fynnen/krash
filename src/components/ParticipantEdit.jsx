...
const ParticipantEdit = props => {
  const { participant, update } = props;
  ...
  return (
    <li>
      ...
      <select
        ...
        onChange={event =>
          update(participant.id, 'location', event.target.value)
        }
      >
      ...
      <select
        ...
        onChange={event => update(participant.id, 'role', event.target.value)}
      >
      ...
      <input
        ...
        onChange={event =>
          update(participant.id, 'available', event.target.checked)
        }
      />
    </li>
  );
